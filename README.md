...
Slime Rogue War is a launchable blade spinner game in a 2d arena, with emphasis on action based gameplay.

It features a github pages deployed CI cd pipeline and a windows build + demo build.

WIP: [playable demo](https://konstantinsteinmiller.github.io/slime-rogue-war/)

![Slime Rogue War Gameplay](https://github.com/konstantinsteinmiller/slime-rogue-war/blob/main/src/assets/documentation/gameplay.webp)
...
- Build-Toolchain
  ...
  - [x] build for windows
    ...
    - [x] build for ios
    - [ ] Poki.io launch
    - [ ] Game Distribution launch
    - [ ] Explore Amazon Games launch
    - [ ] Itch launch
    - [ ] wavedash launch
    - [ ] Glitch launch
    - [x] Crazy Web games SDK

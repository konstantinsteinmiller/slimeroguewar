...
> A reusable reference for recreating the proven features of Slime Rogue War in a new casual game project using **Vue 3 +
...
- Peer ID format: `slime-rogue-war-{random8chars}`.
...
- **`statsFor()` caching**: Functions called per-blade in O(n²) collision loops should be cached
